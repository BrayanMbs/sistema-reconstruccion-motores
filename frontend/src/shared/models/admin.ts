...
export type WorkOrder = { id: string; code: string; trackingCode: string; clientId: string; clientName: string; engineBrand: string; engineModel: string; engineSerial: string | null; serviceType: string; description: string; status: WorkOrderStatus; progress: number; assignedWorkerId: string | null; assignedWorker: string | null; estimatedDate: string | null; createdAt: string; intakeNotes: string | null; publicNote: string | null; priority: WorkOrderPriority; startedAt: string | null; completedAt: string | null; totalAmount: number | null };
...
export type AdministrativeDashboard = { clients: number; orders: { total: number; pending: number; in_progress: number; completed: number; unassigned: number }; upcoming: WorkOrder[] };
