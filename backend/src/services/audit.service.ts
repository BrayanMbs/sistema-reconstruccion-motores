...
export class AuditService {
  ...
  record(actorId: string | undefined, action: string, entityType: string, entityId?: string, details?: Record<string, unknown>) { return this.repository.record({ actorId, action, entityType, entityId, details }); }
