...
import { createClient, listClients, getClient } from "../controllers/client.controller";
...
adminRouter.route("/clients").get(asyncHandler(listClients)).post(asyncHandler(createClient)); adminRouter.get("/clients/:id", asyncHandler(getClient));
adminRouter.route("/work-orders").get(asyncHandler(listWorkOrders)).post(asyncHandler(createWorkOrder)); adminRouter.get("/work-orders/:id", asyncHandler(getWorkOrder)); adminRouter.patch("/work-orders/:id/assignee", asyncHandler(assignWorkOrder));
