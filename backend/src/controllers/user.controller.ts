...
export const resetPassword = async (request: Request, response: Response): Promise<void> => { response.json(await service.resetPassword(requireText(request.params.id, "Identificador"), request.appUser!.id)); };
